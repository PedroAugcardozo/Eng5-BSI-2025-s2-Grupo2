...
public class EstoqueControl{
    ...
    public Boolean AtualizarEstoqueAlimento(int idAlimento, int qtde){
        try{
            ...
            return alimento.atualizarEstoque(idAlimento, qtde);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    //é necessario passar o valor total (buscar o valor no banco e fazer a conta de qtde no seu metodo), por Exemplo 45 camisas ou 15 calças
